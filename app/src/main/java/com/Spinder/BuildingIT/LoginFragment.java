package com.Spinder.BuildingIT;
...
public class LoginFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Welcometxt = (TextView) view.findViewById(R.id.Main_Welcome_Txt);
        PlsLogintxt = (TextView) view.findViewById(R.id.Please_Login_Txt);
    ...
    public void onResume() {
        ...
        if (isLoggedIn()) {
            ...
            PlsLogintxt.setVisibility(View.INVISIBLE);
